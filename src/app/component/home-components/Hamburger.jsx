        ...
        <div className="relative">
            ...
            >
                <ul className="flex flex-col gap-6 text-xl">
                    ...
                    <Link href="/Auth" onClick={toggleLinks}><li className="hover:text-[#E3A23D]">Login/Logout</li></Link>                    <Link href="/Orders" onClick={toggleLinks}><li className="hover:text-[#E3A23D]">Orders</li></Link>
